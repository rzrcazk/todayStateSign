// 轻量级 MCP Server 实现 - 不依赖 @modelcontextprotocol/sdk
// 适用于直接 HTTP 集成场景
...
// 导出工厂函数
export function createLightweightMCPServer(env: Env): LightweightMCPServer {
  return new LightweightMCPServer(env);
}
